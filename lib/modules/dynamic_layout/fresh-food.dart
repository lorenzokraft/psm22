            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children:  [
                    Text('Fresh Food',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: Colors.green.shade700)),
                  ],
                ),
              ),
...
List<SubCategory>  subCategories=[
  SubCategory(title: 'Fresh Food', subCategories: 'Dairy & Eggs',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTEzNzcxOTUzOA==',icon: const Icon(Icons.arrow_drop_down)),
  SubCategory(title: 'Fresh Food', subCategories: 'Meat & Poultry',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTEzNzYyMTIzNA==',icon: const Icon(Icons.arrow_drop_down)),
