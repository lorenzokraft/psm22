            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children:  [
                    Text('Beverages',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: Colors.green.shade700)),
                  ],
                ),
              ),
...
List<SubCategory>  subCategories=[
  SubCategory(title: 'Beverages', subCategories: 'Tea',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTEzOTYyMDA4Mg==',icon: const Icon(Icons.arrow_drop_down)),
  SubCategory(title: 'Beverages', subCategories: 'Coffee',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTEzOTU4NzMxNA==',icon: const Icon(Icons.arrow_drop_down)),
  SubCategory(title: 'Beverages', subCategories: 'Herbal Drinks',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTEzOTU1NDU0Ng==',icon: const Icon(Icons.arrow_drop_down)),
  SubCategory(title: 'Beverages', subCategories: 'Flavoured Syrups',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTEzOTUyMTc3OA==',icon: const Icon(Icons.arrow_drop_down)),
  SubCategory(title: 'Beverages', subCategories: 'Juices',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTEzOTQ4OTAxMA==',icon: const Icon(Icons.arrow_drop_down)),
  SubCategory(title: 'Beverages', subCategories: 'Pakistani Soft Drinks',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTEzOTQ1NjI0Mg==',icon: const Icon(Icons.arrow_drop_down)),
  SubCategory(title: 'Beverages', subCategories: 'Kids Drinks',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTEzOTQyMzQ3NA==',icon: const Icon(Icons.arrow_drop_down)),
  SubCategory(title: 'Beverages', subCategories: 'Powdered Drinks',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTEzOTM5MDcwNg==',icon: const Icon(Icons.arrow_drop_down)),
  SubCategory(title: 'Beverages', subCategories: 'Water',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTEzOTM1NzkzOA==',icon: const Icon(Icons.arrow_drop_down)),
];