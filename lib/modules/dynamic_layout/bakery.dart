            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children:  [
                    Text('Bakery',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: Colors.green.shade700)),
                  ],
                ),
              ),
...
List<SubCategory>  subCategories=[
  SubCategory(title: 'Bakery', subCategories: 'Sweets',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTE0MDg2NTI2Ng==',icon: const Icon(Icons.arrow_drop_down)),
  SubCategory(title: 'Bakery', subCategories: 'Bread & Buns',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTE0MDgzMjQ5OA==',icon: const Icon(Icons.arrow_drop_down)),
  SubCategory(title: 'Bakery', subCategories: 'Puff & Biscuits',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTE0MDc2Njk2Mg==',icon: const Icon(Icons.arrow_drop_down)),
];