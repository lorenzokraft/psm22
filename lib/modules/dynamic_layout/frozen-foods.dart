...
class FrozenFoods extends StatefulWidget {
  const FrozenFoods({Key? key}) : super(key: key);
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children:  [
                    Text('Frozen Foods',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: Colors.green.shade700)),
                  ],
                ),
              ),
...
List<SubCategory>  subCategories=[
  SubCategory(title: 'Frozen Foods', subCategories: 'Ice Cream & Deserts',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTE0MDA3ODgzNA==',icon: const Icon(Icons.arrow_drop_down)),
  SubCategory(title: 'Frozen Foods', subCategories: 'Meat & Poultry',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTEzNzYyMTIzNA==',icon: const Icon(Icons.arrow_drop_down)),
  SubCategory(title: 'Frozen Foods', subCategories: 'Ready to Eat',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTE0MDI0MjY3NA==',icon: const Icon(Icons.arrow_drop_down)),
];