...
class PakFoods extends StatefulWidget {
  const PakFoods({Key? key}) : super(key: key);

  @override
  State<PakFoods> createState() => PakFoodsState();
}

class PakFoodsState extends State<PakFoods> {
  @override
          ...
          GestureDetector(
            onTap: () {
              Navigator.of(context, rootNavigator: true).pushReplacement(
                  MaterialPageRoute(
                      builder: (context) => BaseDeliveryMode(fromHome: true)));
            },
            child: Container(
              height: 50,
              ...
              itemBuilder: (context, index) {
                return Padding(
                  ...
                  child: foodItemContainer(
                      context, subCategories[index].subCategories, () {
