...
class FruitVegetables extends StatefulWidget {
  const FruitVegetables({Key? key}) : super(key: key);

  @override
  _FruitVegetablesState createState() => _FruitVegetablesState();
}

class _FruitVegetablesState extends State<FruitVegetables> {
  @override
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children:  [
                    Text('Fruits & Vegetables',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: Colors.green.shade700)),
                  ],
                ),
              ),
...
List<SubCategory>  subCategories=[
  SubCategory(title: 'Fruit & Vegetables', subCategories: 'Fruits',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTEzODM3NDg5OA==',icon: const Icon(Icons.arrow_drop_down)),
  SubCategory(title: 'Fruit & Vegetables', subCategories: 'Vegetables',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTEzODMwOTM2Mg==',icon: const Icon(Icons.arrow_drop_down)),
  SubCategory(title: 'Fruit & Vegetables', subCategories: 'Herbs',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTEzODIxMTA1OA==',icon: const Icon(Icons.arrow_drop_down)),
  SubCategory(title: 'Fruit & Vegetables', subCategories: 'Fresh Box',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTEzODE3ODI5MA==',icon: const Icon(Icons.arrow_drop_down)),
  SubCategory(title: 'Fruit & Vegetables', subCategories: 'Mangoes',id: 'Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQwNTEzODE0NTUyMg==',icon: const Icon(Icons.arrow_drop_down)),
];